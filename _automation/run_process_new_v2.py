...
async def process_new_comprehensive():
    ...
    try:
        ...
        # Sign-up events are always skipped.
        ...
        # Keywords that always skip (sign-ups, registrations)
        skip_always_keywords = ['signup', 'sign up', 'sign-up', 'registration']
        ...
        for ei, event in enumerate(all_events_list):
            ...
            # Always skip sign-up / registration events
            if any(kw in summary_lower for kw in skip_always_keywords):
