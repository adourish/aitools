...
async def process_new_comprehensive():
    ...
    try:
        ...
        for ei, event in enumerate(all_events_list):
            ...
            sign_up_keywords = ['signup', 'sign up', 'sign-up', 'registration', 'enroll']
            is_sign_up = any(kw in summary_lower for kw in sign_up_keywords)
            if is_sign_up and not needs_attention:
