...
Analyzes email threads over 30 days with full context and creates single consolidated daily plan
"""
...
async def process_new_comprehensive():
    ...
    try:
        ...
        # Sign-up and registration events are not actionable calendar items
