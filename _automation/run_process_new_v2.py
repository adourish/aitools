...
async def process_new_comprehensive():
    ...
    try:
        ...
        # Calendar events that are sign-up/registration type are never actionable tasks
        signup_event_keywords = ['signup', 'sign-up', 'sign up', 'registration']
        ...
        for ei, event in enumerate(all_events_list):
            ...
            # Skip sign-up / registration events — they are not actionable tasks
            if any(kw in summary_lower for kw in signup_event_keywords):
