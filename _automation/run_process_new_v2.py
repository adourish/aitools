...
async def process_new_comprehensive():
    ...
    try:
        ...
        # OneDrive updates and sign-up events are always skipped
        ...
        skip_keywords = [
            'onedrive', 'one drive', 'sign up', 'signup', 'sign-up',
        ...
        for ei, event in enumerate(all_events_list):
            ...
            if any(kw in summary_lower for kw in skip_keywords):
                logger.info(f"   Skipped OneDrive/sign-up event: {summary[:60]}")
                continue
