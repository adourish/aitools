...
async def process_new_comprehensive():
    ...
    # Step 6: Create detailed breakdown for output
    ...
    try:
        ...
        exclude_keywords = ['signup', 'sign up', 'sign-up', 'registration', 'register to']
        ...
        for ei, event in enumerate(all_events_list):
            ...
            # Skip sign-up events entirely
            if any(kw in summary_lower for kw in exclude_keywords):
