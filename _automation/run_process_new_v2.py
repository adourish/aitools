...
async def process_new_comprehensive():
    ...
    try:
        ...
        # Terms that indicate a sign-up/registration event (always skip as tasks)
        signup_terms = ['signup', 'sign up', 'sign-up', 'register for', 'registration open']
        ...
        for ei, event in enumerate(all_events_list):
            ...
            # Skip signup/registration calendar events (e.g., Tae Kwon Do signup)
            if any(term in summary_lower for term in signup_terms):
