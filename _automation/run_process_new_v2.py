...
async def process_new_comprehensive():
    ...
    try:
        ...
        # Sign-up events are always skipped unless they need attention.
        ...
        signup_keywords = [
            ...
            'registration opens', 'enrollment opens', 'register now',
        ]
        ...
        for ei, event in enumerate(all_events_list):
            ...
            # Skip sign-up events unless they require special attention
