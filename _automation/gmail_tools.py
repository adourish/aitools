...
class GmailTools:
    ...
    def __init__(self, auth_manager):
        ...
        self.skip_senders = [
            ...
            'onedrive@', 'no-reply@microsoft.com', 'o365mc@',
            'noreply@microsoft.com', 'microsoft-noreply@microsoft.com',
        ]
        ...
        self.skip_keywords = [
            ...
            # Sign-up / new account emails
            'sign up', 'sign-up', 'signup', 'create your account',
            'confirm your registration', 'activate your account',
            'welcome to your new account', 'get started for free',
