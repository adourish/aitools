...
class GmailTools:
    ...
    def __init__(self, auth_manager):
        ...
        self.skip_senders = [
            ...
            # Microsoft OneDrive/SharePoint notification emails
            'onedrive', 'sharepoint', 'sharepointonline.com',
            'notification.microsoft.com', 'officeupdates.microsoft.com',
        ]
        ...
        self.skip_keywords = [
            ...
            'welcome to our', 'thanks for registering', 'thanks for signing up',
            'verify your email address', 'confirm your email address',
            'registration confirmed', 'account created', "you've been signed up",
            # OneDrive/SharePoint file update notifications
            'shared a file with you', 'file has been shared',
            'edited a shared file', 'added files to your onedrive',
        ]
