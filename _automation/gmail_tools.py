...
class GmailTools:
    ...
    def __init__(self, auth_manager):
        ...
        self.skip_senders = [
            ...
            # OneDrive and cloud storage notifications
            'onedrive.com', 'sharepoint.com',
            'storage-noreply@microsoft.com', 'msonlineservicesteam@microsoftonline.com',
        ]
        ...
        self.skip_keywords = [
            ...
            'your onedrive storage', 'onedrive is almost full',
            'files have been shared with you on onedrive',
            'shared a file with you on onedrive',
            'invited you to access a file',
            'your onedrive is', 'onedrive for business',
            # Sign-up / registration confirmation emails (not actionable)
            ...
            'complete your registration', 'finish setting up your account',
            'your account has been created', 'your account is ready',
            'welcome, you\'re all set', 'you\'ve been signed up',
            'welcome aboard', 'welcome to your new account',
        ]
