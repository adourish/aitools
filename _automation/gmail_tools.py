...
class GmailTools:
    ...
    def __init__(self, auth_manager):
        ...
        self.skip_keywords = [
            ...
            # OneDrive updates
            'shared with you in onedrive', 'updated their file in onedrive',
            'onedrive file', 'onedrive update',
            # Sign-up promotions
            'sign up now', 'sign up today', 'signup now',
            'sign up for free', 'sign up to get',
        ]
