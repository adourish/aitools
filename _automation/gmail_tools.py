...
class GmailTools:
    ...
    def __init__(self, auth_manager):
        ...
        self.skip_keywords = [
            ...
            'onedrive storage', 'your onedrive', 'files in onedrive',
            'shared a file with you', 'shared a folder with you',
            'invited you to view', 'has shared', 'files are waiting',
        ]
