...
class GmailTools:
    ...
    def __init__(self, auth_manager):
        ...
        self.skip_keywords = [
            ...
            'sign up', 'sign-up', 'signup', 'create an account',
            'register now', 'join now', 'get started for free',
            'confirm your registration', 'activate your account',
            'verify your account', 'complete your registration',
            'finish setting up your account', 'welcome to our community',
            'thanks for registering', 'thanks for signing up',
