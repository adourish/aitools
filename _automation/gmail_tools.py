...
class GmailTools:
    ...
    def __init__(self, auth_manager):
        ...
        self.skip_senders = [
            ...
            'onedrive@', 'sharepointonline.com', 'noreply@microsoft.com',
            'onedrive.live.com', 'microsoft-noreply@microsoft.com',
        ]
        ...
        self.skip_keywords = [
            ...
            # Sign-up/registration notifications (informational)
            'sign up now', 'signup now', 'you have signed up',
            'registration confirmation', 'you are registered',
