...
class GmailTools:
    ...
    def __init__(self, auth_manager):
        ...
        self.skip_senders = [
            ...
            'onedrive', 'sharepoint.com', 'no-reply@microsoft.com',
            'notifications@microsoft.com', 'noreply@microsoft.com',
        ]
        ...
        self.skip_keywords = [
            ...
            'shared a file with you', 'onedrive update', 'sharepoint update',
