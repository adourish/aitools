...
class GmailTools:
    ...
    def __init__(self, auth_manager):
        ...
        self.skip_keywords = [
            ...
            'complete your signup', 'confirm your registration',
            'verify your email address', 'activate your account',
            'welcome aboard', "you've signed up", 'you have signed up',
            'email confirmation required', 'confirm your subscription',
        ]
