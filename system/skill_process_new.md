...
**Automatically created in your Todoist (individual tasks):**
...
- ✅ **Sign-up events skipped** - Registration/sign-up calendar events are excluded

**How it works:**
- **Every run:** Deletes ALL old `🎯 TODAY:` and `⏰ SOON:` tasks
- **Then creates:** Individual DO NOW tasks + DO SOON summary
...
- Recurring routine events without attention keywords
...
- ✅ Sign-up events excluded from task creation
...
- Skips sign-up and registration calendar events
