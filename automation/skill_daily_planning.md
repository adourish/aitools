...
2. **Intelligent Email Analysis** (15-20 seconds)
   ...
   - **Deduplication**: Removes duplicate items across Gmail, Todoist
...
- ❌ **OneDrive/File sharing**: Microsoft file-sharing notifications
- ❌ **Sign-ups**: Registration confirmations, email verification prompts
...
|---------|------|---------|
| 3.0.0 | 2026-04-09 | V3 AI thread analysis, claude-haiku-4-5 model, OneDrive/signup filtering |
